...
def getHistFracErr(data, data_misID, rangeMax):
...
kaons_hist, kaons_frac, kaons_err, kaons_bins = getHistFracErr(kaons_P, kaons_misID, 200)
pions_hist, pions_frac, pions_err, pions_bins = getHistFracErr(pions_P, pions_misID, 200)
...
kaons_hist, kaons_frac, kaons_err, kaons_bins = getHistFracErr(kaons_P, kaons_misID, 1000)
pions_hist, pions_frac, pions_err, pions_bins = getHistFracErr(pions_P, pions_misID, 1000)


#Getting data for protons
protons_P = Ptot[(trueID == 2212)]
protons_misID = Ptot[(isMuon == True) & (trueID == 2212)]
protons_hist, protons_frac, protons_err, protons_bins = getHistFracErr(protons_P, protons_misID, 1000)
