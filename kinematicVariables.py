...
plt.savefig("img/kinematicvariables/kinematic_mup.png")
...
plt.subplots_adjust(wspace = 0.4)
plt.savefig("img/kinematicvariables/kinematic_mum.png")
...
plt.subplots_adjust(wspace = 0.4)
plt.savefig("img/kinematicvariables/kinematic_dimuon.png")
