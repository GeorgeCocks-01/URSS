...
kaons_P = P[(trueID == 321) & (P > 1)]
pions_P = P[(trueID == 211) & (P > 1)]
protons_P = P[(trueID == 2212) & (P > 1)]
type0_P = P[(trueID == 0) & (P > 1)]

kaons_misID = P[(isMuon == True) & (trueID == 321) & (P > 1)]
pions_misID = P[(isMuon == True) & (trueID == 211) & (P > 1)]
protons_misID = P[(isMuon == True) & (trueID == 2212) & (P > 1)]
type0_misID = P[(isMuon == True) & (trueID == 0) & (P > 1)]

kaons_hist, kaons_bins = np.histogram(kaons_P, bins = 50, range = [20, 200])
pions_hist, pions_bins = np.histogram(pions_P, bins = 50, range = [20, 200])
protons_hist, protons_bins = np.histogram(protons_P, bins = 50, range = [20, 200])
type0_hist, type0_bins = np.histogram(type0_P, bins = 50, range = [20, 200])


kaons_frac = np.histogram(kaons_misID, bins = 50, range = [20, 200])[0]/kaons_hist
pions_frac = np.histogram(pions_misID, bins = 50, range = [20, 200])[0]/pions_hist
protons_frac = np.histogram(protons_misID, bins = 50, range = [20, 200])[0]/protons_hist
type0_frac = np.histogram(type0_misID, bins = 50, range = [20, 200])[0]/type0_hist
