...
with uproot.open("../WmassMeasurement/mW/data/tuples/Wp_QcdBgdPt18GeV_13TeV_SmearingAll_AlignCorrOn_InitialMomScaleCorrOff.root:DecayTree") as file:
  qcd = file.arrays(["mu_pt", "mu_P", "mu_isMuon", "mu_trueID"], library = "pd")
...
qcd.loc[pions, "Pweight"] = 1/qcd.loc[pions, "mu_P"]
qcd.loc[kaons, "Pweight"] = 1/qcd.loc[kaons, "mu_P"]

#Equation weights for pions and kaons
qcd.loc[pions, "weight"] = pionbfrac*pionMass/(qcd.loc[pions, "mu_P"]*pionTau)
qcd.loc[kaons, "weight"] = (kaonbfrac + kaonpibfrac)*kaonMass/(qcd.loc[kaons, "mu_P"]*kaonTau)
...
plt.savefig("img/test/weightscomparison.png")
plt.close()
...
# plt.ylabel("Normalised Counts")
# plt.title("Comparing weights for particle types")
# plt.savefig("img/test/weightscomparisonLog.png")
# plt.close()
...
# plt.savefig("img/test/weightscomparisonMuonTrue.png")
# plt.close()
...
# plt.savefig("img/test/weightscomparisonW.png")
# plt.close()
...
# plt.savefig("img/test/weightscomparisonLengths.png")
# plt.close()
...
# plt.ylabel("Counts")
# plt.title("Investigating the difference protons make to the pT distribution")
# plt.savefig("img/test/weightscomparisonProtonsEB.png")
# plt.close()
